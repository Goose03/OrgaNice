...
export default function InfoAccordion() {
  ...
  return (
    <>
      <div className="flex flex-col items-center justify-center bg-white border rounded-xl border-gray-200 shadow md:flex-row md:max-w-xl">
        <div id="accordion-heading" data-accordion={open}>
          <h2 id="features">
            <button
              type="button"
              className="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-900 rounded-m bg-gray-100 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-white dark:bg-gray-800 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3"
